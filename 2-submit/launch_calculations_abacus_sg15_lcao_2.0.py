...
class EosSubmissionController(FromGroupSubmissionController):
    ...
    def get_inputs_and_processclass_from_extras(self, extras_values):
        ...
        inputs = {
            ...
            'base': {'pseudo_family': 'SG15_v1.0_v2.0/standard' },
            'base_final_scf': {'pseudo_family': 'SG15_v1.0_v2.0/standard'},
...
if __name__ == "__main__":
    ...
    WORKFLOWS_GROUP_LABEL = f'acwf-verification/{SET_NAME}/workflows/{PLUGIN_NAME}_v2.0_orbs'
