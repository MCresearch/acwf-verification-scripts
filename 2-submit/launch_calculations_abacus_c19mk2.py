...
DRY_RUN = False
MAX_CONCURRENT = 30
PLUGIN_NAME = "abacus_c19mk2"
CODE_LABEL = (
    "abacus-3.10lts@catapult"  # <-- Change this to the code configured to run ABACUS
)
    ...
    def get_inputs_and_processclass_from_extras(self, extras_values):
        ...
        for engine in engine_types:
            engines[engine] = {
                ...
                "options": {
                    ...
                    * 4,  # <- UPDATE these settings according to your scheduler
                },
            }
        ...
        inputs = {
            ...
            "generator_inputs": {  # code-agnostic inputs for the relaxation
                "engines": engines,
                # I had to manually modify the pseudopotential family as in the protocol.yaml file as the default dojo potential will not pass family verification as it conatiners fewer elements.
                "protocol": "verification-PBE-v1",  # Use the standard verification-PBE-v1 protocol
            ...
            "sub_process": {
                "base": {
                    "pseudo_family": "CASTEP/C19MK2/PBE/upf",
                     # Override the pseudo family and use a fixed cut-off energy
                    "abacus": {"parameters": {"input": {"ecutwfc": 800/ 13.60569, "ecutrho": 800/ 13.60569 * 4, "ks_solver": "dav"}}}
                },
                "base_final_scf": {
                    "pseudo_family": "CASTEP/C19MK2/PBE/upf",
                    "abacus": {"parameters": {"input": {"ecutwfc": 800/ 13.60569, "ecutrho": 800/ 13.60569 * 4, "ks_solver": "dav"}}}
...
if __name__ == "__main__":
    try:
        ...
        print(
            "Pass as parameter the set name, e.g. oxides-verification-PBE-v1 or unaries-verification-PBE-v1"
        )
        sys.exit(1)
